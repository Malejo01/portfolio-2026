 ...
 *
 * Las cuatro fuentes estructuradas del nodo son las que están en `enabled:
 * true` dentro de `SCRAPE_SOURCES` del repo de Qué Pinta Salta, menos
 * Instagram, que tiene carril propio. Los cines NO van acá aunque el sitio
 * los muestre: `cinema-scraper.ts` escribe a `cinema_movies`, no a `events`,
 * así que no pasan por esta compuerta ni por el dedup.
 *
  ...
  return (
    <DiagramFigure surface="paper" caption={labels.caption} className={className}>
      ...
      <motion.svg {...svgProps} viewBox="0 0 940 360" className={`${svgProps.className} max-[759px]:hidden`}>
        ...
        <motion.g data-reveal="" variants={node(0.11)}>
        ...
        <motion.g data-reveal="" variants={node(0.38)}>
        ...
        <motion.path data-reveal="" variants={edge(0.57, 0.32)} d="M208 110 H268" fill="none" stroke={p.soft} strokeWidth="0.5" />
        <motion.path data-reveal="" variants={edge(0.63, 0.32)} d="M208 270 H268" fill="none" stroke={p.accent} strokeWidth="0.5" />

        {/* La compuerta es el único borde de 1px del sitio: el grosor es el énfasis. */}
        <motion.g data-reveal="" variants={node(0.81)}>
        ...
        <motion.path data-reveal="" variants={edge(1.08, 0.35)} d="M468 110 C 500 110 496 170 528 170" fill="none" stroke={p.soft} strokeWidth="0.5" />
        <motion.path data-reveal="" variants={edge(1.14, 0.35)} d="M468 270 C 500 270 496 210 528 210" fill="none" stroke={p.accent} strokeWidth="0.5" />
        ...
        <motion.path data-reveal="" variants={edge(1.65, 0.35)} d="M698 170 C 730 170 726 110 758 110" fill="none" stroke={p.soft} strokeWidth="0.5" />
        <motion.path data-reveal="" variants={edge(1.71, 0.35)} d="M698 210 C 730 210 726 270 758 270" fill="none" stroke={p.soft} strokeWidth="0.5" />
      </motion.svg>
      ...
      <motion.svg {...svgProps} viewBox="0 0 340 770" className={`${svgProps.className} min-[760px]:hidden`}>
        ...
        <motion.path data-reveal="" variants={edge(0.41, 0.28)} d="M90 96 V124" fill="none" stroke={p.soft} strokeWidth="0.5" />

        <motion.g data-reveal="" variants={node(0.22)}>
        ...
        <motion.path data-reveal="" variants={edge(0.85, 0.28)} d="M170 308 V336" fill="none" stroke={p.accent} strokeWidth="0.5" />

        <motion.g data-reveal="" variants={node(0.66)}>
        ...
        <motion.path data-reveal="" variants={edge(1.27, 0.5)} d="M90 196 V212 H36 V452 H110 V470" fill="none" stroke={p.soft} strokeWidth="0.5" strokeLinejoin="round" />
        <motion.path data-reveal="" variants={edge(1.35, 0.32)} d="M230 408 V470" fill="none" stroke={p.accent} strokeWidth="0.5" />
        ...
        <motion.g data-reveal="" variants={node(1.66)}>
        ...
        <motion.path data-reveal="" variants={edge(1.84, 0.28)} d="M110 564 V600" fill="none" stroke={p.soft} strokeWidth="0.5" />
        <motion.path data-reveal="" variants={edge(1.9, 0.5)} d="M230 564 V578 H304 V680 H190 V694" fill="none" stroke={p.soft} strokeWidth="0.5" strokeLinejoin="round" />
      </motion.svg>
