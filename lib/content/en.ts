...
export const en: Content = {
  ...
  caseMaestria: {
    ...
    steps: [
      ...
      "Generates up to 40 questions combining multiple choice, true/false, short answer, and numeric with an approximation margin.",
    ...
    stack: ["Next.js", "TypeScript", "Prisma", "PostgreSQL", "Tailwind", "LLM APIs"],
    shots: [
      "MaestrIA quiz configuration screen showing parameters for a 3rd-year secondary Mathematics quiz, with a question count selector up to 40 and the four available question types.",
      "Preview of a Mathematics question generated by MaestrIA about the similarity of geometric figures.",
