...
export const es: Content = {
  ...
  caseMaestria: {
    ...
    steps: [
      "El docente sube el programa de su materia en PDF o DOCX.",
      "El sistema extrae unidades y temas, y genera evaluaciones y trabajos prácticos alineados a ese programa específico.",
      "Roles diferenciados: docente y estudiante, con historial persistente y métricas de progreso.",
